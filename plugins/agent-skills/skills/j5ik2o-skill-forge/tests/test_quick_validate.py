...
class TestPlatformFrontmatter:
    ...
    def test_accepts_author_namespaced_name(self, tmp_path):
        write_skill(
            tmp_path,
            "name: j5ik2o-test-skill\n"
            "description: Test skill\n",
        )
    ...
    def test_rejects_multiple_namespace_colons(self, tmp_path):
        write_skill(
            tmp_path,
            "name: vendor:group:test-skill\n"
            "description: Test skill\n",
        )
        ...
        assert valid is False
        assert "at most one namespace colon" in message
