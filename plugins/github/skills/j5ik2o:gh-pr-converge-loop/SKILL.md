---
name: j5ik2o:gh-pr-converge-loop
description: >-
  Run a convergence loop for GitHub PRs by resolving base-branch merge conflicts
  first with the j5ik2o:gh-pr-resolve-conflicts skill, addressing unresolved review
  feedback with the j5ik2o:gh-pr-review-follow-up skill, and fixing failing PR checks.
